...
Verify the PortSwigger MCP endpoint on loopback, then inspect DoubleAgent's readiness endpoint and extension output. Local MCP control traffic should not be sent through the Burp proxy.
